...
<div className="relative flex flex-col justify-center px-5 sm:px-10 md:px-16 lg:px-20 py-8 sm:py-10 md:py-12">
  ...
  {errors.password && (
    ...
    <div className="flex items-center justify-between">
      ...
      >
        ...
        <span className="text-xs sm:text-sm md:text-sm text-[#6E6F72]">
          Remember Me
        </span>
      </label>
      <a
        href="#"
        className="text-xs sm:text-sm md:text-sm text-[#599400] hover:underline"
      >
        Forget Password?
      </a>
    </div>
    ...
    <Button
      type="submit"
      className="w-full h-10 sm:h-12 md:h-14 rounded-md bg-[#599400] hover:bg-[#4d8500] text-white text-sm sm:text-base md:text-base shadow"
    >
      Login →
    </Button>
  </form>
  ...
  <div className="absolute bottom-3 sm:bottom-5 left-1/2 -translate-x-1/2 -ml-4 sm:-ml-6">
    <a
      href="#"
      className="text-xs sm:text-sm md:text-sm text-[#599400] hover:underline flex items-center gap-2"
    >
