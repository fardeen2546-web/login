        ...
        >
          ...
          <div className="relative bg-white">
            ...
            {errors.email && email.trim() === "" && (
              <p className="mt-1 text-red-500 text-xs absolute left-10 top-[100%]">
                Email is required
              </p>
            )}
          </div>
          ...
          {/* Password */}
          <div className="relative bg-white">
            <TbLockPassword className="absolute left-3 top-2.5 w-5 h-5 text-gray-500" />
            <Input
              id="password"
            ...
            >
              {showPassword ? (
                <EyeOff className="w-5 h-5 text-[#599400]" />
              ) : (
                <Eye className="w-5 h-5 text-[#599400]" />
              )}
            </button>
